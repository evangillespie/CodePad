...
#define MIN_PAUSE_TIME_BETWEEN_RUNS 420000
#define MAX_PAUSE_TIME_BETWEEN_RUNS 720000
...
#define CLOCK_SWEEP_TIME_DELAY 47000
...
#define TUBA_SOUND_SOUND_TIME_MINIMUM 800
// maximum time between sounds in a set
#define TUBA_SOUND_SOUND_TIME_MAXIMUM 2700
...
#define LANDSCAPE_TUBE_MIN_ACTIVE_TIME 20000
// Maximum active time (ms)
#define LANDSCAPE_TUBE_MAX_ACTIVE_TIME 100000

// Number of Neopixels that light up the landscape tube
#define LANDSCAPE_TUBE_NUM_NEOPIXELS 12

// CONFIG VARIABLES FOR THE PIZZA OVEN SEQUENCE
#define PIZZA_OVEN_PAUSE_TIME_MIN 360000
#define PIZZA_OVEN_PAUSE_TIME_MAX 600000
