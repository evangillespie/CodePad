...
bool Keypad::_is_code_special(int entered_code){
	...
	int special_codes[] = {4827, 8110, 3827, 2864, 5348, 8433, 2317, 7467, 5792,
				2438, 6161, 2654, 5340, 3427, 3714, 4953, 3687, 3555,
				7552, 9893, 2038, 7112, 9661, 932, 4339, 8475, 5967, 7285};
	// ^^^
...
void Keypad::_execute_special_code_sequence(int entered_code){
	...
	switch (entered_code){
		...
		case 7285:
			delay(500);
			//tubaman pops out and plays a random tuba blast
			g_sound_manager.play_sound(random(1,146));
			//Solenoid pops TUBAMAN out of coo coo clock
			digitalWrite(TUBA_PLAYER_SOLENOID_PIN, HIGH);
			delay(2000);
			//Solenoid pops TUBAMAN back in coo coo clock
