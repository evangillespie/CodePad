...
void PauseState::_turn_system_on(){
	...
	g_led_fade_manager.fade(7, 100, 0, 80);

	//Radar Screen - LED_5_PIN brightness 50
	//g_led_fade_manager.fade(5, 100, 0, 50);

	//Power crystals - LED_12_PIN brightness 40 
	g_led_fade_manager.fade(12, 100, 0, 40);

	//Yellow LED inside Keyapd - LED_2_PIN brightness 40 
	g_led_fade_manager.fade(1, 100, 0, 40); 
...
int PauseState::_get_random_tuba_sound_index(){
	// ARRAY FOR THE SOUND INDECIES OF ALL TUBA SOUNDS
