...
void FailState::_dispatcher() {
	switch(_state_num){
		...
		case 2:
			...
			// Keypad yellow leds fade up to brightness 40
			g_led_fade_manager.fade(1, 3000, 0, 40);
			...
			g_led_fade_manager.fade(7, 3000, 0, 80);

			//power crystal LED fades from 40-10 over 2 seconds
			g_led_fade_manager.fade(12, 2000, 80, 40);
