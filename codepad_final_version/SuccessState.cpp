	...
	switch(_state_num){
		...
		case 3:
			if (_substate == 0){
				...
				g_led_fade_manager.fade(12, 1500, 220, 40);
		...
		case 5:
			...
			//Radar screen fades up to 220 brightness 
		...
		case 8:
			if (_substate == 0){
				...
				//Fade power crystals up to 220
				g_led_fade_manager.fade(12, 3000, 40, 220);
		...
		case 9:
			...
			//Fade power crystal led down
			g_led_fade_manager.fade(12, 2500, 220, 40);
		...
		case 10:
			...
			g_led_fade_manager.fade(1, 2000, 0, 40);
		...
		case 12:
			if (_substate == 0){
				...
				g_led_fade_manager.fade(7, 2000, 0, 80);
