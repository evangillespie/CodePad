...
void SuccessState::_dispatcher() {
	switch(_state_num){
		...
		case 5:
			...
			//Radar screen begins fading sequence radar (blips)    //This is causing shift register to glitch out.   
		...
		case 8:
			...
			if (_substate == 0){
				...
				//g_led_fade_manager.fade(5, 4000, 200, 10); //This is cauing a short of the shift register.  ?
						...
						if (millis() >= _times[i]){
							switch (i){
								...
								case 3:
									...
									g_led_fade_manager.fade(7, 1500, 0, 70);
